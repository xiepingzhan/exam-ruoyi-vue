...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange">
      ...
      <el-table-column
        ...
        prop="fileName" >
        <template v-slot="{row}">
          <router-link :to="'/testGroup/index/' + row.importId" class="link-type">
            <span>{{row.fileName}}</span></router-link>
        </template>
      </el-table-column>
...
<script>
import { listGroup, getGroup, delGroup, addGroup, updateGroup,getImportInfo } from "@/api/hgExam-ui/group/index";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      if(params.hasOwnProperty('createTime')&&params.createTime!=undefined){
        params.EndTime= params.createTime[1]
        params.startTime= params.createTime[0]
        delete params.createTime
      }
      this.loading = true;
      getImportInfo(params).then(response => {
