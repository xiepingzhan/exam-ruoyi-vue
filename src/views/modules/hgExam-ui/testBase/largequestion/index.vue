<template>
  <div class="largequestion app-container">
    <!-- 问答题 -->
      <el-row :gutter="20">
          <el-col>
              <!-- 检索 -->
      ...
      <el-row :gutter="20">
          <el-col :span="1.5">
              <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd(null, '新增问答题')"
          ...
          <el-table :data="tableList" @selection-change="handleSelect">
              ...
              <el-table-column show-overflow-tooltip label="操作" width="150">
                  <template slot-scope="scoped">
                      <el-button size="mini" type="warning" @click="handleAdd(scoped.row.largequestionId, '修改问答题')">修改
                      </el-button>
                      <el-button size="mini" type="danger" @click="deleteThis(scoped.row.largequestionId)">删除
                      </el-button>
                  </template>
              </el-table-column>
          </el-table>
