<template>
  <div class="compoundquestion app-container">
    <!-- 复合题 -->
      <el-row :gutter="20">
          <el-col>
              <!-- 检索 -->
      ...
      <el-row :gutter="20">
          <el-col :span="1.5">
              <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd(null, '新增复合题')"
      ...
      <div class="table" style="margin-top:10px">
          <el-table :data="tableList" @selection-change="handleSelect">
              ...
              <el-table-column show-overflow-tooltip label="答案" prop="answer"></el-table-column>
              ...
              <el-table-column show-overflow-tooltip label="操作" width="150">
                  <template slot-scope="scoped">
                      <el-button size="mini" type="warning" @click="handleAdd(scoped.row.compoundquestionId, '修改复合题')">修改
                      </el-button>
                      <el-button size="mini" type="danger" @click="deleteThis(scoped.row.compoundquestionId)">删除
                      </el-button>
                  </template>
              </el-table-column>
          </el-table>
