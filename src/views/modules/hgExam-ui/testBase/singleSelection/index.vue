<template>
    <div class="singleSelection app-container">
        <el-row :gutter="20">
            <el-col>
                <!-- 检索 -->
                <el-form :model="queryForm" ref="myForm" inline :rules="rules" size="mini">
        ...
        <el-row :gutter="20">
            <el-col :span="1.5">
                <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd(null, '新增单选题')"
                ...
                <el-table-column show-overflow-tooltip label="操作" width="150">
                    <template slot-scope="scoped">
                        <el-button size="mini" type="warning"
                            @click="handleAdd(scoped.row.singleelectionId, '修改单选题')">修改
                        </el-button>
                        <el-button size="mini" type="danger" @click="deleteThis(scoped.row.singleelectionId)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <updateDialog v-if="visible" ref="updateDialog" :baseUrl="requestOptions.baseUrl" :id="targetId" :title="title"
            :type="type" :levelList="dict.testquestionslevel" :typeList="dict.testquestionstype" @savefn="savefn"
