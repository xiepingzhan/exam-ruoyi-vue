<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="附件上传">
        <el-upload
          ...
          action="#"
        >
          <el-button type="primary" >{{isOpen?"附件上传":'未解之谜--100'}}</el-button>
        </el-upload>
      </el-form-item>
      <el-table :data="fileList" v-if="false">
    ...
    <div slot="footer" style="text-align: right">
      <el-button type="primary" size="small" @click="isOpen = !isOpen">上传状态切换</el-button>
