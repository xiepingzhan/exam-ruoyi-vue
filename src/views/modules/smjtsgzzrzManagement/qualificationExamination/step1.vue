...
<!--          </el-form-item>-->
      ...
      <el-col>
        <el-table :data="tableList" style="width: 100%">
          ...
          <el-table-column width="150" show-overflow-tooltip label="试卷名称" prop="title"/>
          <el-table-column width="100" show-overflow-tooltip label="试卷类型" prop="papertype">
            <template
              v-slot="scope"
            >
              {{typeList.find(item=>item.dictValue==scope.row.papertype)?
              typeList.find(item=>item.dictValue==scope.row.papertype).dictLabel:
              "-"}}
            </template>
          </el-table-column>
          ...
          <el-table-column width="150" label="截止日期" prop="otime" />
          ...
          <el-table-column width="120" show-overflow-tooltip label="试卷状态">
            <template slot-scope="{row:data}">
...
<!--              </el-button>-->
              ...
              <el-button
                ...
                v-else
                type="primary"
                style="background:gray;border-color:gray;">试卷过期
              </el-button>
            </template>
          </el-table-column>
        </el-table>
